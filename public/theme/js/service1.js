                ...
                success: function (response) {
                    if (response.code === '200' && response.status === 'success') {
                        Swal.fire({
                            ...
                            customClass: {
                                confirmButton: 'btn btn-Pawver1_success btn-info'  // Thêm class Bootstrap cho nút confirm
                            }
                        }).then(() => {
...
function showReaction() {
    ...
    if (reaction_type === 'all' || reaction_type === 'ALL') {
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        Swal.fire({
                            ...
                            confirmButtonText: "Ok, got it!",
                            customClass: {
                                confirmButton: 'btn btn-dalymmocom_success btn-info'  // Thêm class Bootstrap cho nút confirm
                            }
                        }).then(() => {
                            window.location.reload();
                        });
